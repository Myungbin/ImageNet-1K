...
def unpack(
    ...
    for class_zip in sorted(os.listdir(target_train_dir)):
        ...
        shutil.unpack_archive(
            os.path.join(target_train_dir, class_zip), os.path.join(target_train_dir, class2num[class_])
        )
    ...
    with open(txt_dir, "r") as txt_file:
        ...
        for line in lines:
            ...
            shutil.move(os.path.join(target_val_dir, val_img), os.path.join(target_val_dir, class2num[class_]))
